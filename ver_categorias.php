...
try {
	...
	$consulta_preparada = $conexion -> prepare("SELECT SQL_CALC_FOUND_ROWS * FROM cate_insumo ORDER BY id_cate LIMIT $inicio, $postporpagina");
...
require('views\ver_categorias.view.php');
